...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] text-slate-900 flex items-center justify-center relative overflow-hidden font-sans">
      {/* Background Orbs */}
      <div className="fixed top-[-10%] left-[-5%] w-[500px] h-[500px] bg-primary/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="fixed bottom-[-10%] right-[-5%] w-[600px] h-[600px] bg-secondary/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md px-6 relative z-10">
        ...
        <div className="bg-white border border-slate-200/60 shadow-2xl shadow-slate-200/50 p-8 md:p-10 rounded-[2rem]">
          ...
          <p className="text-slate-500 text-center mb-8 text-sm">Enter your credentials to access your dashboard</p>
          ...
          <div className="relative flex items-center mb-8">
            ...
            <span className="px-4 text-slate-400 text-[10px] font-bold tracking-widest uppercase">Or email login</span>
            <div className="flex-1 border-t border-slate-100"></div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input 
                ...
                required 
                className="w-full bg-slate-50/50 border border-slate-200 h-14 px-4 rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-base"
              />
            </div>
