        ...
        <div className="relative z-10 space-y-10">
          <div>
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white leading-[0.85] tracking-tighter italic uppercase mb-8">
              Adaptive <br /> Learning <br /> <span className="text-indigo-200">Engine.</span>
            </h2>
            <p className="max-w-md text-sm font-semibold text-white/60 leading-relaxed uppercase tracking-wide">
              Personalized AI-powered courses, smart assessment nodes, and real-time synaptic tracking.
            </p>
          </div>
 
          {/* Feature dots */}
          <div className="space-y-4">
            {['Adaptive Neural Paths', 'AI Synapse Tutoring', 'Quantum Analytics'].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="mb-10">
            ...
            <p className="text-[11px] font-black tracking-[0.2em] uppercase opacity-40"> Initialize secure learning session </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-indigo-900/40 mb-3 ml-1">
                Synapse ID / Email
              </label>
              <input
                type="email"
            ...
            <div>
              <div className="flex items-center justify-between mb-3 mx-1">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-900/40">Encryption / Password</label>
                <button
                  type="button"
                  className="text-[9px] font-black uppercase tracking-widest text-indigo-600 hover:tracking-[0.2em] transition-all"
                >
                  Retrieve Access →
                </button>
              </div>
            ...
            >
              {loading ? (
                <><Loader2 size={24} className="animate-spin" /> <span className="text-[12px] font-black tracking-[0.2em] uppercase">Authenticating...</span></>
              ) : (
                <div className="flex items-center justify-center gap-4">
                   <span className="text-[12px] font-black tracking-[0.2em] uppercase">Initialize Portal</span>
